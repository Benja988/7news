...
export default function OpenGraph({
  ...
  return (
    <Head>
      ...
      <meta name="keywords" content={tags?.join(', ') || "news, technology, science, business, politics, entertainment, health, sports"} />
      ...
      <meta property="og:site_name" content="HintFlow" />
